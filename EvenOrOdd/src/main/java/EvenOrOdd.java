public class EvenOrOdd {
     ...
     * odd. The method should return the String "Even" if the number is even, and "Odd" if it is
     * odd.
     *
     ...
     *
     * @param n a number.
     * @return a String "Even" if n is even, and "Odd" of in is odd. The test cases
     *         are case-sensitive.
     */
