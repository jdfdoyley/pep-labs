 ...
 *
 * Or, we could have an array of our own custom Objects, such as our own Bird class for a
 * birdwatching application. This would allow us to keep track of many birds and their own behavior.
 *
