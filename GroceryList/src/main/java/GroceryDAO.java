 ...
 * of objects in Java to rows in a database. The methods here are mostly filled
 * out, you will just need to add a SQL statement.
 *
 * We may assume that the database has already created a table named
 * 'groceries'.
...
public class GroceryDAO {
    ...
    /**
     * TODO: Insert a new row into the Grocery table, with the sole column
     * containing groceryName.
     * You only need to change the sql String, the rest of the method is already
     * complete.
     *
