...
public class InstantiationExample {
    /**
     * Java relies very heavily on OOP, so all of our code will rely on Objects. Before we write
     * our own objects, let's first look into how we can leverage them in our code. Every test, for
     * instance, has to first create an object before it runs the code contained within. Let's do
