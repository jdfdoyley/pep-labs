 ...
 * puzzle game "Towers of Hanoi". They are used in algorithms where it is needed
 * to keep track of the ordering in which the elements were inserted.
 *
 ...
 * from either the top or bottom. You can use ArrayDeque to perform stack
 * operations. You can read about ArrayDeque in the official Javadocs here:
 * https://docs.oracle.com/javase/7/docs/api/java/util/ArrayDeque.html
 * And you can read about the stack class here (deque exhibits the same behavior
 * as Stack and contains the same methods):
 * https://docs.oracle.com/javase/7/docs/api/java/util/Stack.html
 */
public class StackExercise {
    /**
     * Implement and return some class that implements Deque, such as ArrayDeque,
     * which contains all the functionality of a Stack. This challenge will not be
     * using the Stack class, because the Stack class is known to have a shoddy
     * implementation as it hasn't been changed since the very earliest version of
     * Java. Deques were made to exhibit the exact same behavior and are generally
     * better.
     *
