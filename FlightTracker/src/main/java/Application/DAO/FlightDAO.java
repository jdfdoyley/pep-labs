...
public class FlightDAO {
     ...
     * looks something like this: String sql = "select * from TableName where
     * ColumnName = ?";
     ...
     * identifies the question mark to be illed (left to right, starting from zero)
     * and the second argument identifies the value to be used:
    ...
    /**
     * Add a flight record into the database which matches the values
     * contained in the flight object.
     * You can use the getters already written in the Flight class to retrieve its
     * values (getDeparture_city(), getArrival_city()). The flight_id will be
     * automatically generated by the SQL database, and JDBC will be able to
     * retrieve the generated ID automatically. That means that you when you insert
     * the flight, you only need to define the departure_city and arrival_city
     ...
     * The question marks will be filled in by the preparedStatement setString,
     * setInt, etc methods. they follow this format, where the first argument
     * identifies the question mark to be
     * filled (left to right, starting from zero) and the second argument identifies
    ...
    public Flight insertFlight(Flight flight) {
        ...
        try {
            ...
            // departure_city and arrival_city values (two columns total!)
    ...
    /**
     * Update the flight identified by the flight id to the values contained
