...
public class FlightAppTest {
     ...
     * should return a list containing that flight. It should not contain other
     * flights.
     */
    @Test
     ...
     * flight, the flight should be returned because the add should be successful.
     * Subsequent attempts to add the flight should return null as the flight
     * already exists. Also, verify that the addFlight method of the flightDAO is
     * actually called.
     */
    @Test
     ...
     * service class, flightService.getAllFlightsFromCityToCity should return all
     * the flights between two cities.
     */
    @Test
    public void getFlightsFromCityToCityTest1() {
        ...
        // want to develop a solution that relies on filtering within the Service rather
        // than in the SQL query.
        // Filtering in Java is less efficient than in a SQL query, but it still works.
