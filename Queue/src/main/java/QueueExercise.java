 ...
 * algorithms where it is needed to keep track of the order that the elements
 * were inserted in. For instance, tech support tickets may be waiting in a
 * queue until a tech support specialist can clear them.
 *
 ...
 * from either the top or bottom. You can use
 * ArrayDeque to perform queue operations. You can read about ArrayDeque in the
 * official Javadocs here:
 ...
 * functionality to handle multiple 'priorities' of items. You can read about
 * PriorityQueue here:
...
public class QueueExercise {
     ...
     *
     * @return an instantiated Queue. Queue, by itself, doesn't have a class, so you
     *         should use a class that implements the Queue interface, such as
     *         ArrayDeque. Deques contain all the methods required for both Queue
     *         and Stack behavior.
     */
